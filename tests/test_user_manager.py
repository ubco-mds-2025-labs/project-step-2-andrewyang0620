...
from src.userprofile import manage_user
from src.userprofile.user import RegularUser, PremiumUser
...
class TestUserManager(unittest.TestCase):
    ...
    def test_register_user_premium_and_invalid_age(self):
        ...
        with patch("builtins.input", side_effect=inputs), \
             patch("src.userprofile.manage_user.uuid.uuid4",
                   return_value="another-uuid-999999"), \
             patch("src.userprofile.manage_user.time.sleep"):
